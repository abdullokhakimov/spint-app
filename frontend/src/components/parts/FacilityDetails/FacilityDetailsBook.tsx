...
import { useCreateOrderMutation, useSavePhoneNumberMutation } from "../../../services/react-query/queries";
	...
	return (
		<div className="facility-details__bron">
			...
			<PhoneNumber
				...
				userID={user.id}
				mutateSavePhoneNumber={mutateSavePhoneNumber}
				statusSavePhoneNumber={statusSavePhoneNumber}
				resetSavePhoneNumber={resetSavePhoneNumber}
			/>
		</div>
	)
}
